(function(H){
		...
		//FIXFOR-V9
		//REPDEV-26803 Set Forecast as Regresstion for Line chart on SSRM throw errorArray.prototype.forEach called on null or undefined
		//common function which is being missed in HC9
		getSegmentPathHC4 = function (segment) {
			var series = this,
				segmentPath = [],
...
/*********** line  *************/
		...
		***/
		H.seriesTypes.linesegmented.prototype.getSegments = function(f){
			...
			if (pointsLength) { // no action required for []
			    ...
			    if (series.options.connectNulls) {
					...
					each(points, function (point, i) {
						point.segmentColor = point.segmentColor || point.color;
		...
		H.seriesTypes.linesegmented.prototype.getSegmentPath = Highcharts.seriesTypes.line.prototype.getSegmentPath || //regular HC4
			getSegmentPathHC4;//HC9
		...
		H.seriesTypes.linesegmented.prototype.drawGraph = function (f) {
			...
			each(props, function (prop, i) {
					...
					if (graph) {// cancel running animations, #459
						...
						//FIXFOR-V9
						//REPDEV-26803: Highcharts v9-Set Forecast as Regresstion for Line chart on SSRM throw error"Array.prototype.forEach called on null or undefined"
						graph.show = function (inherit) {
							graph.forEach(function (probablySvgElement) {
								probablySvgElement.show && probablySvgElement.show(inherit);
							})
						};
						graph.hide = function (hideByTranslation) {
							graph.forEach(function (probablySvgElement) {
								probablySvgElement.hide && probablySvgElement.hide(hideByTranslation);
							})
						};
						each(graphPath, function(segment, j) {
...
/********* spline ************/
	    ...
	    //FIXFOR-V9 
        //REPDEV-26803: Highcharts v9-Set Forecast as Regresstion for Line chart on SSRM throw error"Array.prototype.forEach called on null or undefined"
		H.seriesTypes.splinesegmented.prototype.getSegmentPath = Highcharts.seriesTypes.line.prototype.getSegmentPath || //regular HC4
			getSegmentPathHC4;//HC9
