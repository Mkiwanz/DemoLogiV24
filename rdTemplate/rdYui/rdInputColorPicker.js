YUI.add('rdInputColorPicker', function (Y) {
    ...
    Y.namespace('LogiXML').rdInputColorPicker = Y.Base.create('rdInputColorPicker', Y.Base, [], {
        ...
        initializer: function (config) {
            ...
            this._handlers[this.id] = this._handlers[this.id] || {}

            if (img) {
                this._handlers[this.id].click = img.on('click', this.click, this);
            }
            ...
            this._handlers[this.id].click = colorIndicator.on('click', this.click, this);
            ...
            this._handlers[this.id].pickerMouseDown = this.picker.on('mousedown', this.mousedown, this);

            this._handlers[this.id].pickerTouchstart = this.picker.on('touchstart', this.mousedown, this);
            ...
            if (this.input !== false) {
                ...
                this._handlers[this.id].inputKeyUp = this.input.on('change', this.onInputChangeUpdate, this);
            ...
            this._handlers[this.id].lostFocus = this.input.on('blur', this.lostfocus,this);
            this._handlers[this.id].gotFocus = this.input.on('focus', this.gotfocus,this);

            if (this.component !== false) {
                this._handlers[this.id].componentClick = this.component.on('click', this.show, this);
            }

            if ((this.input === false) && (this.component === false)) {
                this._handlers[this.id].elementClick = this.element.on('click', this.show, this);
            }

            // for HTML5 input[type='color']
            if ((this.input !== false) && (this.component !== false) && (this.input.attr('type') === 'color')) {

                this._handlers[this.id].inputClick = this.input.on('click', this.show, this);
                this._handlers[this.id].inputFocus = this.input.on('focus', this.show, this);
            }
            this.update();
        },
        ...
        clearMouseDownAndMouseMoveEvents: function() {
            if (this._handlers[this.id].documentMouseMove) {
                this._handlers[this.id].documentMouseMove.detach();
                this._handlers[this.id].documentMouseMove = null;
            }
            if (this._handlers[this.id].documentTouchmove) {
                this._handlers[this.id].documentTouchmove.detach();
                this._handlers[this.id].documentTouchmove = null;
            }
            if (this._handlers[this.id].documentMouseUp) {
                this._handlers[this.id].documentMouseUp.detach();
                this._handlers[this.id].documentMouseUp = null;
            }
            if (this._handlers[this.id].documentTouchend) {
                this._handlers[this.id].documentTouchend.detach();
                this._handlers[this.id].documentTouchend = null;
            }
        },
        ...
        mousedown: function (e) {
            ...
            if (!zone.hasClass('colorpicker')) {
                ...
                var doc = Y.one(document);
                this._handlers[this.id].documentMouseMove = doc.on('mousemove', this.mousemove, this);
                this._handlers[this.id].documentTouchmove = doc.on('touchmove', this.mousemove, this);
                this._handlers[this.id].documentMouseUp = doc.on('mouseup', this.mouseup, this);
                this._handlers[this.id].documentTouchend = doc.on('touchend', this.mouseup, this);
                this.mousemove(e);
            }
            return false;
        },
        ...
        _clearHandlers: function () {
            var self = this;
            Y.each(this._handlers[this.id], function (item) {
                if (item) {
                    if (item.detach) {
                        item.detach();
                    }
