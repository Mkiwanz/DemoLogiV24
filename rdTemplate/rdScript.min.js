...
*/
YUI.add("popupmenu",function(e){var t=e.YUI2,n;e.namespace("LogiXML").PopupMenu=e.Base.create("popupmenu",e.Base,[],{initializer:function(){this.initializePopupMenus(),LogiXML.Ajax.AjaxTarget().on("reinitialize",e.bind(this.initializePopupMenus,this))},initializePopupMenus:function(){var n=e.all(".rdPopupMenuActivate");n.each(function(n){n.removeClass("rdPopupMenuActivate");var r="click";e.Lang.isValue(n.getData("dhtmlevent"))&&(r=n.getData("dhtmlevent")),n.setData("ppObject",this),n.on(r,e.bind(this.rdShowPopupMenu,this,n.get("id"),n.getData("popuplocation")));var i=n.get("id"),s;i.indexOf("_CtCol")!=-1?s=i.replace("_CtCol","_rdPopup_CtCol"):i.indexOf("_Row")!=-1?s=i.replace("_Row","_rdPopup_Row"):s=i+"_rdPopup";var o=e.one("#"+s);o&&(o.setStyle("left","-9999.33"),o.setStyle("top","-10000"));var u=t.widget.MenuManager.getMenu(s);u&&(u.hide(u),t.widget.MenuManager.removeMenu(u))},this)},rdShowPopupMenu:function(n,r){e.Lang.isValue(this._menu)&&(this._menu.hide(this._menu),t.widget.MenuManager.removeMenu(this._menu));var i;n.indexOf("_CtCol")!=-1?i=n.replace("_CtCol","_rdPopup_CtCol"):n.indexOf("_Row")!=-1?i=n.replace("_Row","_rdPopup_Row"):i=n+"_rdPopup";var s=e.one("#"+i);s||(s=e.one(document.getElementById(i)));if(!s){s=document.getElementById(n),s&&(s=s.getElementsByClassName("rdPopupMenu"),s.length?s=s[0]:s=null);if(!s)throw"Popup with id "+i+" was not found";i=s.getAttribute("id"),s=e.one(s)}var o=s.all("UL");o&&o.each(function(e){e.get("childNodes").each(function(t){t._node&&t._node.nodeName&&t._node.nodeName.toLowerCase().indexOf("rdcondelement")>=0&&t.get("childNodes").each(function(n){e._node.insertBefore(n._node,t._node),e._node.removeChild(t._node)})})});if(n.indexOf("ppPanelMenu")>-1){var u=document.getElementById("rdDivDashboardPanelTable"),a=document.getElementById(i);a.parentNode.id!="rdDivDashboardPanelTable"&&(a.parentNode.removeChild(a),u.appendChild(a));if(typeof rdMobileReport!="undefined"){var f="rdDashboardPanel-"+n.replace("ppPanelMenu_",""),l=document.getElementById(f),c=l.previousSibling,h=l.nextSibling.nextSibling.nextSibling;if(c.id.match("rdDashboardDropZone-0-0")){var p=a.getElementsByTagName("li");for(g=0;g<p.length;g++){var d=p[g];d.innerHTML.match("Move Up")&&(d.style.display="none")}}else{var p=a.getElementsByTagName("li");for(g=0;g<p.length;g++){var d=p[g];d.innerHTML.match("Move Up")&&(d.style.display="")}}if(!h){var p=a.getElementsByTagName("li");for(g=0;g<p.length;g++){var d=p[g];d.innerHTML.match("Move Down")&&(d.style.display="none")}}else{var p=a.getElementsByTagName("li");for(g=0;g<p.length;g++){var d=p[g];d.outerHTML.match("Move Down")&&(d.style.display="")}}}}var v="bl";r&&r.toLowerCase()=="right"&&(v="tr");var m=document.getElementById(i);for(var g=m.firstChild.firstChild.childNodes.length-1;g>-1;g--){var y=m.firstChild.firstChild.childNodes[g],b;y.textContent!=undefined?b=y.textContent:b=y.innerText,b==""&&y.parentNode.removeChild(y)}if(m.innerHTML.match("rdModalShade")&&m.innerHTML.match("rdPopupPanel"))try{var w=m.firstChild,E;if(w)while(w){if(!!w.tagName.toLowerCase().match("ul")){E=w.getElementsByTagName("li");break}w=w.firstChild}for(var g=0;g<E.length;g++)this.MovePopupPanelAsSiblingToPopupMenu(E[g],m)}catch(S){}this._menu=t.widget.MenuManager.getMenu(i),this._menu==undefined?(this._menu=new t.widget.Menu(i,{context:[n,"tl",v]}),this._menu.render(),this._menu.show(this._menu)):this._menu.show(this._menu),document.getElementById(this._menu.id).style.zIndex="9999"},MovePopupPanelAsSiblingToPopupMenu:function(e,t){if(e.innerHTML.match("rdModalShade")&&e.innerHTML.match("rdPopupPanel")){var n=e.getElementsByTagName("div");for(var r=0;r<n.length;r++)n[r]&&n[r].id&&(n[r].id.toLowerCase().match("rdmodalshade")||n[r].id.toLowerCase().match("ppaddbookmarks")||n[r].id.toLowerCase().match("ppeditbookmarks"))&&(t.parentNode.appendChild(n[r]),r-=1)}}},{NAME:"popupmenu",ATTRS:{}})},"1.0.0",{requires:["base","yui2-menu"]});
