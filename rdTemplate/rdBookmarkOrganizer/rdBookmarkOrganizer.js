YUI.add('rd-BookmarkOrganizer-plugin', function (Y) {
    ...
    Y.namespace('LogiXML').rdBookmarkOrganizer = Y.Base.create("rdBookmarkOrganizer", Y.Plugin.Base, [], {
        ...
        initializer: function () {
            ...
            //REPDEV-27558: Fetching isShared boolean to check if the selected folder is "Shared with me" or not.
            var isSharedFolder = document.getElementById('rdIsShared').value;
            ...
            if (selectedFolder)
                this.selectFolder(null, selectedFolder, selectedSharedFolder, selectedSharedParentFolder, isSharedFolder);
            else
        ...
        rdAddFolder: function (sFolderName) {
            ...
            //REPDEV-26933 Apostrophe in bookmark folder name
            var sFolderName = encodeURIComponent(document.getElementById('rdFolderNameText').value);
            var sBookmarkOrganizerID = document.getElementById('rdBookmarkOrganizerID').value;
            var sBookmarkCollection = encodeURIComponent(document.getElementById('rdBookmarkCollection').value);
        ...
        rdRenameFolder: function () {
            ...
            //REPDEV-26933 Apostrophe in bookmark folder name
            var sRenameFolderText = encodeURIComponent(document.getElementById('rdFolderRenameText').value);
            var sBookmarkOrganizerID = document.getElementById('rdBookmarkOrganizerID').value;
            var sBookmarkCollection = encodeURIComponent(document.getElementById('rdBookmarkCollection').value);
            var sReportID = document.getElementById('rdBookmarkOrganizerReport').value;
